...
| 6 | Pipeline de publicação — PDF (rascunho) | producao-material | pronta para PR **com decisão de produto pendente** (BRIEF-024 · SPEC-024 · PLAN-025 Done 17/17; branch `feat/producao-material-mnemora-studio` pushada `83152fd`/`6a5af2b`/`da836d8`; Entrega ACEITA_COM_RESSALVAS 2026-09-15; gate 10 achou risco real de produção — Tira grande com imagens pode exceder o limite de corpo de resposta da Vercel (~4,5 MB) já hoje, RISK-025-007 — recomendado resolver ANTES do merge/deploy, não só depois; PR/merge/deploy pendentes — ato do Diretor) |
