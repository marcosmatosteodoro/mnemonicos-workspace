...
- [x] Comportamento (gate 9): **verificado** — após Diretor aplicar a migração e reiniciar o servidor de dev, `qa` exercitou V1-V3 de `HANDOFF-PLAN-025.md` com ambiente real: download real das 2 Variantes confirmado (`%PDF-1.7`), 3 estados observáveis provados em produção real, sem regressão. `HANDOFF-PLAN-025.md` fechado (`status: Concluído`).
